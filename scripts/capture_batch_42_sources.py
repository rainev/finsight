#!/usr/bin/env python3
"""Capture cutoff-safe SEC Companyfacts/submissions packets for Batch 42."""
...
def capture_sources(*, output_root: Path, reuse_roots=(), user_agent: str | None = None, refresh: bool = False, client=None, protected_serving_roots=PROTECTED_ROOTS) -> dict:
    ...
    reused = [issuer.ticker for issuer in BATCH_42_MANIFEST if cached[issuer.ticker]]
    ...
    for issuer in BATCH_42_MANIFEST:
        ...
        _publish(
            ...
            _packet_payloads(
                ...
                schema_version="FINSIGHT-BATCH-42-SOURCE-1",
            ),
        )
