#!/usr/bin/env python3
"""Capture parsed controlling filings for Batch 09."""
...
def _control(root,issuer):
 ...
 if manifest.get('schema_version')!='FINSIGHT-BATCH-09-SOURCE-1' or manifest.get('issuer')!={'ticker':issuer.ticker,'cik':issuer.cik,'issuer_name':issuer.issuer_name}:raise ValueError(issuer.ticker)
