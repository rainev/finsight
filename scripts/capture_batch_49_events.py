#!/usr/bin/env python3
"""Capture Batch 49 cutoff-event filings and exhibits."""
...
def capture_events(*, source_root: Path, output_root: Path, user_agent: str | None = None) -> dict:
    ...
    for issuer in BATCH_49_MANIFEST:
        ...
        for index, filed in enumerate(recent["filingDate"]):
            ...
            if not ("2026-06-30" <= filed <= BATCH_49_VALUATION_DATE and form in EVENT_FORMS):
                continue
    ...
    summary = {"schema_version": "FINSIGHT-BATCH-49-EVENT-SCREEN-1", "valuation_date": BATCH_49_VALUATION_DATE, "attempted": 10, "cases": cases, "serving_artifacts_changed": False}
