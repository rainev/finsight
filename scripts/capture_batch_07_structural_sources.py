#!/usr/bin/env python3
"""Capture parsed controlling filings for Batch 07."""
...
from app.us_valuation.batch_07 import BATCH_07_MANIFEST,BATCH_07_VALUATION_DATE
...
def _control(root,issuer):
 ...
 if manifest.get('schema_version')!='FINSIGHT-BATCH-07-SOURCE-1' or manifest.get('issuer')!={'ticker':issuer.ticker,'cik':issuer.cik,'issuer_name':issuer.issuer_name}:raise ValueError(issuer.ticker)
