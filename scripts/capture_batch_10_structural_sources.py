#!/usr/bin/env python3
"""Capture parsed controlling filings for Batch 10."""
...
from app.us_valuation.batch_10 import BATCH_10_MANIFEST,BATCH_10_VALUATION_DATE
...
def _control(root,issuer):
 ...
 if manifest.get('schema_version')!='FINSIGHT-BATCH-10-SOURCE-1' or manifest.get('issuer')!={'ticker':issuer.ticker,'cik':issuer.cik,'issuer_name':issuer.issuer_name}:raise ValueError(issuer.ticker)
