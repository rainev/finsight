#!/usr/bin/env python3
"""Capture Batch 47 cutoff-event filings and exhibits."""
...
def capture_events(*,source_root:Path,output_root:Path,user_agent:str|None=None)->dict:
    ...
    for i in BATCH_47_MANIFEST:
        ...
        for idx,filed in enumerate(recent["filingDate"]):
            ...
            if not("2026-06-30"<=filed<=BATCH_47_VALUATION_DATE and form in EVENT_FORMS):continue
    ...
    summary={"schema_version":"FINSIGHT-BATCH-47-EVENT-SCREEN-1","valuation_date":BATCH_47_VALUATION_DATE,"attempted":10,"cases":cases,"serving_artifacts_changed":False};_immutable(output_root/"summary.json",_json(summary));return summary
def main():
