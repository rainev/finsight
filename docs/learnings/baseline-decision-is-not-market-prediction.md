...
checks pass, ordinary uncertainty should produce a broad Low-reliability conditional estimate—not
...
cap reliability at Low, add a short warning, and place it on the Recovery Learning Watchlist. Fully
withhold only for hard safety failures, no economically coherent model, or no finite/nonnegative
decision range. Related: [[public-competitor-methods-are-constraints-not-formulas]],
